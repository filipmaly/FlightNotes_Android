...
public class DatabaseHelper extends SQLiteOpenHelper {
   ...
   // public static final String DATABASE_NAMEA = "Airport.db";
    ...
    public static final String COL_6A = "TEMPERATUE";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table " + TABLE_NAMEA + " (_id INTEGER PRIMARY KEY AUTOINCREMENT,DATE DATE,HOUR TEXT,PLACE TEXT,WEATHER TEXT,TEMPERATURE TEXT,MODEL1 TEXT,MODEL2 TEXT,MODEL3 TEXT,MODEL4 TEXT, MODEL5 TEXT, TIME INTEGER, WIND TEXT )");
    ...
    public boolean insertDataAirport(String date,String hour,String place,String weather,String temperature,String model1,String model2,String model3, String model4, String model5, String time, String wind) {
    ...
    {
    SQLiteDatabase db = this.getWritableDatabase();
        Cursor res = db.rawQuery("select MODEL from "+TABLE_NAMEP, null);
        return res;
    }
    // výpis jen jména a id
    public Cursor getModifyData()
    {
        SQLiteDatabase db = this.getWritableDatabase();
        Cursor res = db.rawQuery( "select _id,NAME from "+TABLE_NAME, null);
        return res;
    }
    ...
    {
        SQLiteDatabase db = this.getWritableDatabase();
        Cursor res = db.rawQuery("select _id,NAME,CYCLE,LASTLOG from " + TABLE_NAME, null);
        if (res != null) {
            res.moveToFirst();
        }
        return res;
    ...
    public Cursor getCurrentDate()
    {
        ...
        SQLiteDatabase db = this.getWritableDatabase();
        Cursor res = db.rawQuery("select * from " + TABLE_NAMEA + " where " + COL_2A + " = " + calendar_activity.selectedDate , null);
